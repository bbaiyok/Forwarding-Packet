...
HD_PWD='C:/Users/baiyo/Forwarding Packet/Forwarding Packet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topGHLM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topGHLM.tcl

...
HD_PWD='C:/Users/baiyo/Forwarding Packet/Forwarding Packet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topGHLM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topGHLM.tcl -notrace

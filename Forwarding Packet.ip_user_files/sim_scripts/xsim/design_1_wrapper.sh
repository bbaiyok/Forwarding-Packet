...
#
# Script generated by Vivado on Fri Mar 21 16:30:09 +0700 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot design_1_wrapper xil_defaultlib.design_1_wrapper -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1_wrapper -key {Behavioral:sim_1:Functional:design_1_wrapper} -tclbatch cmd.tcl -log simulate.log
}

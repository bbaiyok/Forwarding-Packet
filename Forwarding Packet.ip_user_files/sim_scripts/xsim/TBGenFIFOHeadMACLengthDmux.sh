...
#
# Script generated by Vivado on Sun Mar 23 20:45:30 +0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TBGenFIFOHeadMACLengthDmux.sh
...
#
# Usage        : TBGenFIFOHeadMACLengthDmux.sh
#                TBGenFIFOHeadMACLengthDmux.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TBGenFIFOHeadMACLengthDmux.sh [-reset_run]
#                TBGenFIFOHeadMACLengthDmux.sh [-reset_log]
#                TBGenFIFOHeadMACLengthDmux.sh [-help]
#
...
# script info
echo -e "TBGenFIFOHeadMACLengthDmux.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TBGenFIFOHeadMACLengthDmux.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot TBGenFIFOHeadMACLengthDmux xil_defaultlib.TBGenFIFOHeadMACLengthDmux xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TBGenFIFOHeadMACLengthDmux -key {Behavioral:sim_1:Functional:TBGenFIFOHeadMACLengthDmux} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TBGenFIFOHeadMACLengthDmux.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TBGenFIFOHeadMACLengthDmux.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TBGenFIFOHeadMACLengthDmux.sh [-help]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-step]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-lib_map_path]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-reset_run]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-reset_log]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-keep_index]\n\
Usage: TBGenFIFOHeadMACLengthDmux.sh [-noclean_files]\n\n\
